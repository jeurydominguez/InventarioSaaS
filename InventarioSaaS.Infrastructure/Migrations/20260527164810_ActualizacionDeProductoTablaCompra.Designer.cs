...
namespace InventarioSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20260527164810_ActualizacionDeProductoTablaCompra")]
    partial class ActualizacionDeProductoTablaCompra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventarioSaaS.Domain.Entidades.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("InventarioSaaS.Domain.Entidades.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InventarioSaaS.Domain.Entidades.Pago", b =>
                {
                    b.HasOne("InventarioSaaS.Domain.Entidades.CuentasPorCobrar", "CuentaPorCobrar")
                        .WithMany("Pagos")
                        .HasForeignKey("CuentasPorCobrarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InventarioSaaS.Domain.Entidades.Producto", b =>
                {
                    b.HasOne("InventarioSaaS.Domain.Entidades.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InventarioSaaS.Domain.Entidades.Usuario", null)
                        .WithMany()
